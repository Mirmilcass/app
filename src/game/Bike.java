...
public class Bike extends Scan {
	...
	public Bike() {
		...
		name = new String[] { "데이스타", "어드레스", "미라쥬", "City 100", "인테그라", "HYPERSTRADA" };
		who = null;
	}
	...
	public void MethodA() {
		...
		System.out.println(super.who + " " + maker[m] + "의 " + cc[c] + "CC " + type[t] + "인 " + name[n] + "입니다." + "\n");
...
class Act extends Scan {
	...
	public void Now() {
		System.out.println("현재 속도는 : " + speed + "km/h 이며 " + geer + "단입니다. " + feul + "%의 기름이 남았습니다.");
	}
}
